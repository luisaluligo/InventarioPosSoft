					...
					<?php while($fila = $resultado->fetch_assoc()) { ?>
						<tr>
							...
							<td><?php echo $fila['ComApellido']; ?></td>
                                                        ...
                                                        <td>
                                                            <a href="../../Presentacion/html/fmrActualizarComercial.php?Id=<?php echo $fila['IdComercial']; ?>" class="btn btn-warning">Editar</a> 
                                                        <a href="../../Logica/eliminarComercial.php?Id=<?php echo $fila['IdComercial']; ?>" class="btn btn-danger">Eliminar</a>
                                                        </td>
						</tr>
					<?php } ?>
				</tbody>

            ...
            <tbody>
                <?php while($fila = $resultado->fetch_assoc()){?>
                    <tr>
                        ...
                        <td><a href="../../Presentacion/html/fmrActualizarAgente.php?id=<?php echo $fila['IdAgente'];?>" class="btn btn-warning">Editar</a>
                           <a href="../../Logica/eliminarAgente.php?id=<?php echo $fila['IdAgente'];?>" class="btn btn-danger">Eliminar</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>

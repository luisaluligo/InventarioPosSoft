					...
					<?php while($fila = $resultado->fetch_assoc()) { ?>
						<tr>
							...
							<td><?php echo $fila['OnbPos']; ?></td>
                                                        ...
                                                        <td>
                                                            <a href="../../Presentacion/html/fmrActualizarOnboarding.php?Id=<?php echo $fila['OnbCodigo']; ?>" class="btn btn-warning">Editar</a> 
                                                            <a href="../../Logica/eliminarOnboarding.php?Id=<?php echo $fila['OnbCodigo']; ?>" class="btn btn-danger">Eliminar</a>
                                                        </td>
						</tr>
					<?php } ?>
				</tbody>
